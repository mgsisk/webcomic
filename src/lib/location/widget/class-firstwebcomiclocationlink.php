<?php
/**
 * Mgsisk\Webcomic\Location\Widget\FirstWebcomicLocationLink class
 *
 * @package Webcomic
 */
 ...
 *
 * @name First Webcomic Location Link
 * @summary Display a link to the first comic location.
 ...
 */
class FirstWebcomicLocationLink extends WebcomicTermLink {
	/**
	 * Instantiate the class.
	 */
	public function __construct() {
		$this->relation       = 'first';
		$this->description    = __( 'Display a link to the first comic location.', 'webcomic' );
