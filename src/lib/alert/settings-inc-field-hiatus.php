...
<input type="hidden" name="<?php echo esc_attr( $args['label_for'] ); ?>[days][]">
<input type="hidden" name="<?php echo esc_attr( $args['label_for'] ); ?>[emails][]">
<table class="widefat striped webcomic-records">
	<thead>
		<tr>
			<td class="manage-column" scope="col"><?php esc_html_e( 'Days Since', 'webcomic' ); ?></td>
			<td class="manage-column" scope="col"><?php esc_html_e( 'Send Alert To', 'webcomic' ); ?></td>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td><input type="number" name="<?php echo esc_attr( $args['label_for'] ); ?>[days][]" min="1" class="small-text"></td>
		...
		<?php foreach ( $args['option'] as $comics => $emails ) : ?>
			<tr>
				<td><input type="number" name="<?php echo esc_attr( $args['label_for'] ); ?>[days][]" value="<?php echo esc_attr( $comics ); ?>" min="1" class="small-text"></td>
