...
class Widget_WebcomicStorylineLink extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'',
			__( '[Webcomic 4] Storyline Link', 'webcomic' ),
			[
				'description' => __( 'This widget is deprecated; use one of the new Webcomic Storyline Link widgets instead.', 'webcomic' ),
			]
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$output = WebcomicTag::relative_webcomic_term_link_( '%link', $instance['link'], $instance['link'], $instance['target'], $instance['relative'], "{$instance['collection']}_storyline" );
	...
	public function form( $instance ) {
		$instance               += $this->get_instance_defaults();
		$instance['use_instead'] = __( 'one of the new Webcomic Storyline Link widgets', 'webcomic' );
