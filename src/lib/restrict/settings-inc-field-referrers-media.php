...
<p class="description"><?php esc_html_e( 'An alternative image to display in place of comic media for referrer-restricted comics.', 'webcomic' ); ?></p>
