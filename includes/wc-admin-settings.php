...
?>
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<p class="submit">
				<input type="submit" name="Submit" class="button-primary" value="<?php _e( 'Save Changes', 'webcomic'); ?>" /> <span class="alignright setting-description"><?php printf( __( 'WebComic Version %s', 'inkblot' ), get_option( 'inkblot_version' ) ); ?></span>
