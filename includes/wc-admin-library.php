			...
			<?php foreach($comic_files as $file): ?>
				<tr<?php if($i%2): ?> class="alt"<?php endif; ?>>
					<td>
						...
						<div class="row-actions"><span class="delete"><a href="<?php echo wp_nonce_url('admin.php?page=webcomic/includes/wc-admin.php'.$paged_link.'&amp;action=webcomic_delete&amp;file='.$file,'webcomic_delete') ?>" onclick="if(confirm('<?php printf(__("You are about to delete \'%s\'\\n \'Cancel\' to stop, \'OK\' to delete.","webcomic"),$file) ?>')) { return true;}return false;" title="<?php _e('Delete this comic','webcomic') ?>"><?php _e('Delete','webcomic') ?></a></span></div>
					</td>
