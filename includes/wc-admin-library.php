	...
	<form action="" method="post">
		...
		<div class="tablenav">
			...
			<?php if ( current_user_can( 'manage_categories' ) ) { ?>
				...
				<?php } if ( current_user_can( 'edit_others_posts' ) ) { ?>
					<a href="<?php echo wp_nonce_url( $view_link . '&amp;action=comic_regen_thumbs', 'comic_regen_thumbs' ); ?>" class="button" onclick="jQuery( '#comic_regen_thumbs' ).show( 0 );"><?php _e( 'Regenerate All Thumbnails', 'webcomic' ); ?></a>
