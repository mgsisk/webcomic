...
<?php
	if ( 'chapter_edit' == $_REQUEST[ 'action' ] ) {
		...
		if ( $_REQUEST[ 'is_series' ] )
			echo '<div id="message" class="updated fade"><p>' . sprintf( __( 'This is a comic series. If you change the <strong>Chapter Slug</strong> you must also rename <strong>%s</strong>', 'webcomic'), get_comic_directory( 'url', false, $_REQUEST[ 'chapter' ] ) ) . '</p></div>';
?>
