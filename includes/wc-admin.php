...
function webcomic_edit_category_form_pre( $category ) {
	...
	if ( false !== $cat )
		echo '<div id="message" class="updated fade"><p>' . sprintf( __( 'This is a comic category. If you change the <strong>Category Slug</strong> you must also rename <strong>%s</strong>', 'webcomic'), get_comic_directory( 'url', false, $category->term_id ) ) . '</p></div>';
