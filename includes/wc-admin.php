...
function comic_admin_pages_add() {
	...
	$icon     = ( strstr( $mu_check[ 'dirname' ], 'mu-plugins' ) ) ? get_option( 'home' ) . '/' . 'wp-content/mu-plugins/includes/webcomic-small.png' : plugins_url( 'webcomic/includes/webcomic-small.png' );
	
	add_menu_page( __( 'WebComic', 'webcomic' ), __( 'WebComic', 'webcomic' ), 'upload_files', __FILE__, 'comic_page_library', $icon );
