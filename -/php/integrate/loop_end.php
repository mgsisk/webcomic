...
if ( $transcripts = get_webcomic_transcripts() ) : ?>
	...
	<div class="webcomic-transcript-meta">
		<?php
			printf( __( 'Transcribed by %1$s%2$s', "webcomic" ),
				WebcomicTag::get_webcomic_transcript_authors(),
				WebcomicTag::get_the_webcomic_transcript_term_list( 0, "webcomic_language", __( " in ", "webcomic" ), __( ", ", "webcomic" ), __( "", "webcomic" ) )
			);
		?>
	</div>
