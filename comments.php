...
<?php if(have_comments()): ?>
	<h2 id="comments"><?php comments_number(__('No Comments','inkblot'),__('1 Comment','inkblot'),__('% Comments','inkblot')); ?></h2>
	<ol class="commentlist"><?php wp_list_comments() ?></ol>
	<div class="page-navi align-center"><?php paginate_comments_links(); ?></div>
<?php endif; ?>

<?php if('open' == $post->comment_status): ?>
<div id="respond">
	<h3><?php comment_form_title(__('Leave a Reply','inkblot'), __('Leave a Reply to %s','inkblot')); ?></h3>
	...
	<?php endif; ?>
		...
		<p class="align-right"><span class="cancel-comment-reply"><?php cancel_comment_reply_link(__('Cancel','inkblot')) ?>&emsp; </span><input name="submit" type="submit" id="submit" value="<?php _e('Comment','inkblot'); ?>" /><?php comment_id_fields() ?></p>
