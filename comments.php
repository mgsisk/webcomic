...
<div id="respond">
	...
	<?php endif; ?>
		...
		<p class="align-right"><span class="cancel-comment-reply"><?php cancel_comment_reply_link(__('Cancel','inkblot')) ?>&emsp; </span><input name="submit" type="submit" id="submit" value="<?php _e('Comment'); ?>" /><?php comment_id_fields() ?></p>
