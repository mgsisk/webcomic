...
permalink: first_webcomic_storyline_link()
---

> Display a link to the first comic storyline.

```php
first_webcomic_storyline_link( string $link = '&laquo; %title', mixed $term = null, array $args = [], mixed $post = null, array $post_args = [] ) : void
```
