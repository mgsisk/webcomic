...
permalink: first_webcomic_location_link()
---

> Display a link to the first comic location.

```php
first_webcomic_location_link( string $link = '&laquo; %title', mixed $term = null, array $args = [], mixed $post = null, array $post_args = [] ) : void
```
