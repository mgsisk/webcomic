...
class webcomic_admin extends webcomic {
	...
	function hook_admin_menu() {
		...
		if ( !$this->option( 'uninstall' ) ) {
			add_menu_page( __( 'Webcomic', 'webcomic' ), __( 'Webcomic', 'webcomic' ), 'upload_files', 'webcomic_files', array( &$this, 'admin_files' ), $this->url . 'webcomic-includes/icon-small.png', 3 );
				...
				<tbody class="media-item-attributes">
					<tr class="form-field">
						...
						<td>
							...
							<div id="webcomic_transcript[webcomic_lang_<?php echo $k; ?>]"><textarea rows="7" cols="25" name="webcomic_transcript[<?php echo $k; ?>]" id="webcomic_transcript[<?php echo $k; ?>]" class="webcomic_tinymce"><?php echo ( isset( $post_meta[ 'transcripts' ][ $k ][ 'text' ] ) ) ? $post_meta[ 'transcripts' ][ $k ][ 'text' ] : ''; ?></textarea></div>
